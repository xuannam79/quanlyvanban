...
<form action="MainForm.php" method="POST" class="form">
	<div class="TieuDe">
		...
		<div id="content" class="NoiDung">
    		...
    		<div id="TuyChon">
    			<div class="btn-group">
    				<button type='button' onclick="window.location.href='{{url('/DanhSachCongVanDen/1')}}'" class='btn btn-primary1'> <img src='img/vanbanden.jpg' alt='Avatar' class='avatar'><br><a>Văn bản đến</a></button>
    				<button type='button' onclick="window.location.href='http://localhost/PHP/a/detail.php?tab=2'" class='btn btn-primary1'> <img src='img/vanbandi.png' alt='Avatar' class='avatar'><br><a>Văn bản đi</a></button>
    				
    				<button type='button' onclick="window.location.href='{{url('/FrmTaoMoiCongVan')}}'" class='btn btn-primary1'> <img src='img/taomoivaluu.png' alt='Avatar' class='avatar'><br><a>Tạo mới và lưu văn bản</a></button>
