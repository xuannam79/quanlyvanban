...
<h2>Gửi công văn</h2>
<div>
   {!!Form::open(['url'=>'/TaoMoiCongVan','enctype'=>'multipart/form-data','onsubmit'=>'setSelected();','id'=>'FormTaoMoiCongVan'])!!}
...
<br>
   <label class="lbl_ThemCongVan">Chọn các cá nhân để gửi đến</label>
